...
public class Base_Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case Base_Package.BASE_ELEMENT: {
			...
			case Base_Package.MODEL_ELEMENT: {
				...
				if (result == null) result = caseBaseElement(modelElement);
			...
			case Base_Package.UTILITY_ELEMENT: {
				...
				if (result == null) result = caseBaseElement(utilityElement);
			...
			case Base_Package.DESCRIPTION: {
				...
				if (result == null) result = caseBaseElement(description);
			...
			case Base_Package.IMPLEMENTATION_CONSTRAINT: {
				...
				if (result == null) result = caseBaseElement(implementationConstraint);
			...
			case Base_Package.NOTE: {
				...
				if (result == null) result = caseBaseElement(note);
			...
			case Base_Package.TAGGED_VALUE: {
				...
				if (result == null) result = caseBaseElement(taggedValue);
			...
			case Base_Package.ARTIFACT_ELEMENT: {
				...
				if (result == null) result = caseBaseElement(artifactElement);
