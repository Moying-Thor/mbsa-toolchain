 ...
 * @generated
 */
public class RequirementPackageItemProvider extends RequirementElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RequirementPackage_interface_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RequirementPackage_interface_feature", "_UI_RequirementPackage_type"),
				 Requirement_Package.Literals.REQUIREMENT_PACKAGE__INTERFACE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Requirement_Package.Literals.REQUIREMENT_PACKAGE__REQUIREMENT_ELEMENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Requirement_Package.Literals.REQUIREMENT_PACKAGE__REQUIREMENT_ELEMENT,
		...
		newChildDescriptors.add
			(createChildParameter
				(Requirement_Package.Literals.REQUIREMENT_PACKAGE__REQUIREMENT_ELEMENT,
				 Requirement_Factory.eINSTANCE.createRequirement()));

		newChildDescriptors.add
			(createChildParameter
				(Requirement_Package.Literals.REQUIREMENT_PACKAGE__REQUIREMENT_ELEMENT,
				 Requirement_Factory.eINSTANCE.createRequirementRelationship()));
	}
