 ...
 * @generated
 */
public class InputItemProvider extends ComponentAssetItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_input_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_input_feature", "_UI_Input_type"),
				 Component_Package.Literals.INPUT__INPUT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Component_Package.Literals.INPUT__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Input.class)) {
			case Component_Package.INPUT__INPUT:
